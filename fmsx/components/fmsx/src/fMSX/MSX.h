...
/** MSX_SaveDisks() ******************************************/ //
/** Автосохранение изменённых образов дискет.               **/
/** Вызывается при выходе из эмулятора, сбросе, смене диска.**/
/*************************************************************/
void MSX_SaveDisks(void);

/** msx_disk_modified[] **************************************/
/** Флаги изменений дисков A и B (1 = изменён).             **/
/*************************************************************/
extern int msx_disk_modified[2];

/** msx_disk_autosave ****************************************/
/** Включает/выключает автосохранение дисков.               **/
/*************************************************************/
