...
2. Extract the file `full_dump_1.0.4-msx-pc_clean_and_clear.bin`.
   - *Verify integrity:* `md5sum` should be `abec70aca378ea747f555f257db99d47`.
3. Flash it using `esptool.py` with a single command:

```bash
esptool.py -p /dev/ttyUSB0 -b 460800 write_flash 0x0 full_dump_1.0.4-msx-pc_clean_and_clear.bin
```
...
2. Розпакуйте файл `full_dump_1.0.4-msx-pc_clean_and_clear.bin`.
   - *Перевірка цілісності:* `md5sum` має бути `abec70aca378ea747f555f257db99d47`.
...
2. Entpacken Sie die Datei `full_dump_1.0.4-msx-pc_clean_and_clear.bin`.
   - *Integritätsprüfung:* `md5sum` sollte `abec70aca378ea747f555f257db99d47` sein.
...
2. ファイル `full_dump_1.0.4-msx-pc_clean_and_clear.bin` を展開。
   - *整合性確認：* `md5sum` は `abec70aca378ea747f555f257db99d47` であること。
